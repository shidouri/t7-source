...
function setup_skiptos()
{
	...
	skipto::add_saved("street", &zurich_street::skipto_main, "Don't Panic", &zurich_street::skipto_done);
	skipto::add_saved("garage", &zurich_street::function_568e2e07, "Don't Panic 2", &zurich_street::skipto_garage_done);
	skipto::add_saved("rails", &zurich_rails::skipto_main, "Off the Rails", &zurich_rails::skipto_done);
	skipto::add_saved("plaza_battle", &zurich_plaza_battle::skipto_main, "Coalescence Plaza", &zurich_plaza_battle::skipto_done);
	skipto::add_saved("hq", &zurich_hq::skipto_main, "HQ", &zurich_hq::skipto_done);
	skipto::add_saved("sacrifice", &zurich_sacrifice::skipto_main, "Sacrifice", &zurich_sacrifice::skipto_done);
	skipto::add_saved("server_room", &zurich_server_room::skipto_main, "Server Room", &zurich_server_room::skipto_done);
	skipto::add("clearing_start", &zurich_clearing::skipto_start, "Clearing Start", &zurich_clearing::skipto_start_done);
	skipto::add_saved("clearing_waterfall", &zurich_clearing::skipto_waterfall, "Clearing Waterfall", &zurich_clearing::skipto_waterfall_done);
	skipto::add_saved("clearing_path_choice", &zurich_clearing::skipto_path_choice, "Clearing Path Choice", undefined);
	skipto::add("clearing_hub", &zurich_clearing::function_1270c207, "Clearing Hub", &zurich_clearing::function_44c2b6a);
	skipto::add_saved("root_zurich_start", &root_zurich::skipto_main, "Zurich Root", undefined);
	skipto::add_saved("root_zurich_vortex", &root_zurich::function_95b88092, "Zurich Root Vortex", &root_zurich::skipto_done);
	skipto::add_saved("clearing_hub_2", &zurich_clearing::function_1270c207, "Clearing Hub", &zurich_clearing::function_600acf3f);
	skipto::add_saved("root_cairo_start", &root_cairo::skipto_main, "Cairo Root", undefined);
	skipto::add_saved("root_cairo_vortex", &root_cairo::function_95b88092, "Cairo Root Vortex", &root_cairo::skipto_done);
	skipto::add_saved("clearing_hub_3", &zurich_clearing::function_1270c207, "Clearing Hub", &zurich_clearing::function_b42e7a80);
	skipto::add_saved("root_singapore_start", &root_singapore::skipto_main, "Singapore Root", &root_singapore::skipto_start_done);
	skipto::add_saved("root_singapore_vortex", &root_singapore::function_95b88092, "Singapore Root Vortex", &root_singapore::function_53a05865);
	skipto::add_saved("outro_movie", &zurich_outro::function_8c381165, "Outro Movie", &zurich_outro::function_7c294f88);
