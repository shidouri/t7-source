...
function function_de13d6e2(var_be1a191b = 0)
{
	...
	if(var_be1a191b == 1)
	{
		...
		a_env = array(level.var_55c8b6a7, level.var_e3c1476c, level.var_9c3c1d5, level.var_1bfadc08, level.var_8e024b43, level.var_67ffd0da, level.var_accc6632, level.cmxznd, level.var_60c77160);
	}
	else
	{
		a_env = array(level.var_55c8b6a7, level.var_e3c1476c, level.var_9c3c1d5, level.var_1bfadc08, level.var_8e024b43, level.var_67ffd0da, level.var_accc6632, level.cmxznd, level.var_60c77160, level.var_689205c5, level.var_8e94802e, level.var_b496fa97);
	}
