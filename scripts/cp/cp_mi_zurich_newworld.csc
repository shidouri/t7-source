...
/*
	...
	Flags: None
*/
function function_510d6e0e()
{
	// Unsupported VM revision (1B).
}

/*
	Name: train_lockdown_glass_left
	Namespace: cp_mi_zurich_newworld
	Checksum: 0x90D7BA90
	Offset: 0x23A0
	Size: 0x0
	...
	Flags: None
*/
function train_lockdown_glass_left()
{
	// Unsupported VM revision (1B).
}
...
/*
	...
	Flags: None
*/
function function_a251bd0b()
{
	// Unsupported VM revision (1B).
}

/*
	Name: train_brake_flaps
	Namespace: cp_mi_zurich_newworld
	Checksum: 0x429A33FF
	Offset: 0x2DE8
	Size: 0x0
	...
	Flags: None
*/
function train_brake_flaps()
{
	// Unsupported VM revision (1B).
}

/*
	Name: train_brake_flaps_ambient_movement
	Namespace: cp_mi_zurich_newworld
	Checksum: 0x5C437616
	Offset: 0x30A8
	Size: 0x0
	...
	Flags: None
*/
function train_brake_flaps_ambient_movement()
{
	// Unsupported VM revision (1B).
}
