...
function function_b2e2a102()
{
	...
	foreach(t_hazard in level.var_dd5501c7)
	{
		if(isdefined(t_hazard.targetname) && t_hazard.targetname !== "")
		{
			level.var_dd5501c7[t_hazard.targetname].mdl_blade = var_2b73bb92[t_hazard.targetname];
